"use strict";
(self.webpackChunkapp_apexar = self.webpackChunkapp_apexar || []).push([[301], {
    9111: (Oe,H,j)=>{
        j.d(H, {
            ConfigCtrl: ()=>$,
            zv: ()=>v,
            ...
            const C = u=>(d,c)=>{
              ...
              , Q = t(ce, {
                deleteProperty(u, d) {
                    ...
                    return E && m(["delete", [d], c]),
                    E
                },
                set(u, d, c, E) {
                    const K = Reflect.has(u, d)
                      , z = Reflect.get(u, d, E);
                    if (K && (e(z, c) || i.has(c) && e(z, i.get(c))))
                        return !0;
                    ve(d),
                    se(c) && (c = (e=>(e=>e && (q.has(e) ? q.get(e) : Y(e) === Object.prototype || Y(e) === Array.prototype))(e) && e[x] || null)(c) || c);
                    let X = c;
                    ...
                    return Reflect.set(u, d, X, E),
                    m(["set", [d], c, z]),
                    !0
                }
            });
            return i.set(r, Q),
            U.set(Q, [ce, (u=++l[1])=>(w !== u && !p.size && (w = u,
            O.forEach(([d])=>{
                const c = d[1](u);
                c > b && (b = c)
            }
        ...
        function k(e, t, s) {
            ...
            n[3])(f=>{
                o.push(f),
                s ? t(o.splice(0)) : a || (a = Promise.resolve().then(()=>{
                    a = void 0,
                    l && t(o.splice(0))
                }
                ))
        ...
        const y = _({
          ...
          , ne = {
            ...
            replace(e) {
                y.history.length > 1 && (y.history[y.history.length - 1] = e,
                y.view = e)
            },
            goBack() {
          ...
          , v = {
            ...
            formatNativeUrl(e, t, s) {
                ...
                let n = e;
                return n.includes("://") || (n = e.replaceAll("/", "").replaceAll(":", ""),
                n = `${n}://`),
                n.endsWith("/") || (n = `${n}/`),
                this.setWalletConnectDeepLink(n, s),
                `${n}wc?uri=${encodeURIComponent(t)}`
            },
          ...
          , $ = {
            ...
            setConfig(e) {
                ...
                L.setIsCustomMobile(!(null == (t = e.mobileWallets) || !t.length)),
                L.setIsCustomDesktop(!(null == (s = e.desktopWallets) || !s.length)),
        ...
        var De = Object.defineProperty
          ...
          , _e = (e,t)=>{
            for (var s in t || (t = {}))
                Me.call(t, s) && he(e, s, t[s]);
            if (pe)
                for (var s of pe(t))
                    Ue.call(t, s) && he(e, s, t[s]);
            return e
        }
        ;
        ...
        const R_getDesktopListings = e=>(0,
        W.Z)(function*() {
            return J("/w3m/v1/getDesktopListings", e)
        })()
          , R_getMobileListings = e=>(0,
        W.Z)(function*() {
            return J("/w3m/v1/getMobileListings", e)
        })()
          , R_getAllListings = e=>(0,
        W.Z)(function*() {
        ...
        const ye = v.isMobile()
          ...
          , Ne = {
            ...
            W.Z)(function*() {
                ...
                if (v.isArray(e)) {
                    const s = {
                      ...
                      , {listings: n} = yield R_getAllListings(s)
                      , a = Object.values(n);
                    a.sort((o,i)=>e.indexOf(o.id) - e.indexOf(i.id)),
                    M.recomendedWallets = a
                } else {
                    const {chains: s, isAuth: n} = L.state
                      , a = s?.join(",")
                      , o = v.isArray(t)
                      , i = {
                        page: 1,
                      ...
                      , {listings: l} = ye ? yield R_getMobileListings(i) : yield R_getDesktopListings(i);
            ...
            W.Z)(function*() {
                const t = ((e,t)=>{
                  ...
                  , {recomendedWallets: a} = M;
                if ("ALL" === n)
                    return M.wallets;
                a.length ? t.excludedIds = a.map(b=>b.id).join(",") : v.isArray(s) && (t.excludedIds = s.join(",")),
                v.isArray(n) && (t.excludedIds = [t.excludedIds, n].filter(Boolean).join(",")),
                L.state.isAuth && (t.sdks = "auth_v1");
                const {page: o, search: i} = e
                  , {listings: l, total: h} = ye ? yield R_getMobileListings(t) : yield R_getDesktopListings(t)
                  , r = Object.values(l)
                  , f = i ? "search" : "wallets";
                return M[f] = {
          ...
          , $e = {
            ...
            W.Z)(function*() {
                return new Promise(t=>{
                    const {isUiLoaded: s, isDataLoaded: n} = L.state;
                    if (v.removeWalletConnectDeepLink(),
                    L.setWalletConnectUri(e?.uri),
                    L.setChains(e?.chains),
                    ne.reset("ConnectWallet"),
                    s && n)
                        V.open = !0,
                        t();
                    else {
                        const a = setInterval(()=>{
                            const o = L.state;
                            o.isUiLoaded && o.isDataLoaded && (clearInterval(a),
                            V.open = !0,
                            t())
                        }
                        , 200)
        ...
        const Z = _({
          ...
          , ze = {
            ...
            setThemeConfig(e) {
                ...
                t && (Z.themeMode = t),
                s && (Z.themeVariables = ((e,t)=>{
                    for (var s in t || (t = {}))
                        Ke.call(t, s) && we(e, s, t[s]);
                    if (be)
                        for (var s of be(t))
                            xe.call(t, s) && we(e, s, t[s]);
                    return e
                }
                )({}, s))
            }
    ...
    3301: (Oe,H,j)=>{
        ...
        class x {
            constructor(P) {
                this.openModal = A.jb.open,
                this.closeModal = A.jb.close,
                this.subscribeModal = A.jb.subscribe,
                this.setTheme = A.ThemeCtrl.setThemeConfig,
                A.ThemeCtrl.setThemeConfig(P),
                A.ConfigCtrl.setConfig(P),
                this.initUi()
            }
            initUi() {
                return (0,
